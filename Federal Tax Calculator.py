print('Canadian Income Tax Calculator 2019- Vlad Vassilyev')
b=(47630,95259,147667,210371,9999999999)
r=(.15,.205,.26,.29,.33)
print('This program does not take tax credits into account, it only calculates ones federal and provincial tax liability on their Division B Income, also known as net income for tax purposes')
x=float(input('What is your net income for tax purposes this year?'))
if x<=b[0]:
    tt=(x*r[0])
elif x<=b[1]:
...
if p=='ON':
    print('Here are your 2019 income tax results in the province of Ontario')
elif p=='NF':
    print('Here are your 2019 income tax results in the province of Newfoundland and Labrador')
elif p=='PEI':
    print('Here are your 2019 income tax results in the province of Prince Edward Island')
elif p=='NS':
    print('Here are your 2019 income tax results in the province of Nova Scotia')
elif p=='NB':
    print('Here are your 2019 income tax results in the province of New Brunswick')
elif p=='SK':
    print('Here are your 2019 income tax results in the province of Saskatchewan')
elif p=='AB':
    print('Here are your 2019 income tax results in the province of Alberta')
elif p=='BC':
    print('Here are your 2019 income tax results in the province of British Columbia')
elif p=='YU':
    print('Here are your 2019 income tax results in the territory of Yukon')
elif p=='NWT':
    print('Here are your 2019 income tax results in the Northwest Territory')
elif p=='NU':
    print('Here are your 2019 income tax results in the territory of Nunavut')
else:
